  ...
  return (
    <section id="home" className="relative min-h-screen overflow-hidden flex items-center justify-center pt-20">
      <video autoPlay muted loop className="absolute inset-0 w-full h-full object-cover">
        <source src="https://videos.pexels.com/video-files/11666380/11666380-sd_640_360_24fps.mp4" type="video/mp4" />
      </video>

      {/* Gradient overlay - enhanced for luxury feel */}
      <div className="absolute inset-0 bg-gradient-to-b from-slate-900/70 via-slate-900/50 to-slate-950/80" />
      ...
      <div className="relative z-10 max-w-5xl mx-auto text-center px-4">
        ...
        >
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-amber-400 to-amber-600 flex items-center justify-center shadow-2xl border-2 border-amber-300/30">
